...
import { useUser } from '../../contexts/UserContext'; // useAuth 대신 useUser로 변경

const CreateReportPage = () => {
  const { user } = useUser(); // useAuth 대신 useUser 사용
    ...
    <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
      ...
      <Paper component="form" onSubmit={handleSubmit} sx={{ p: 3, mt: 3 }}>
        <Typography variant="body2" sx={{ mb: 2 }}>
          보고서 작성 시 다음과 같은 Markdown 문법을 사용할 수 있습니다:
          <br />
          # 대제목
          <br />
          ## 중제목
        ...
        <Button type="submit" variant="contained" color="primary" fullWidth disabled={loading} sx={{ mt: 2 }}>
          {loading ? <CircularProgress size={24} /> : '보고서 저장'}
        </Button>
      </Paper>
...
CreateReportPage.getLayout = function getLayout(page) {
