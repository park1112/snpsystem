...
const GenerateReportPage = () => {
  ...
  const handleGeneratePrompt = () => {
    ...
    prompt +=
      '베트남과 중국에서 수입한 과일, 농산물, 가공품, 냉동과즙을 한국 시장에 판매하기 위한 시장조사를 기반으로 종합적인 보고서를 작성해 주세요. 보고서는 가격 비교와 품질 비교를 바탕으로 어떤품목을 수입하였을 경우 더 경쟁력이 있는지를 나타내는 아이템 발굴의 보고서입니다. \n\n';

    prompt += '보고서에는 다음 항목을 포함해 주세요\n';

    prompt += '1. 가격분석 : 조사한 제품의 가격을 비교하고 품질을 비교하여 가장 경쟁력 있는 제품을 찾아내는 분석\n';
    prompt += '2. 소비자 분석: 어떤 제품이 더 좋을지 소비자의 선호도를 분석하는 분석\n';
    prompt +=
      '3. 경쟁 제품 분석: 베트남 및 중국에서 수입한 제품들과 경쟁하는 태국, 필리핀 제품들과의 가격 및 품질 경쟁력 비교.\n';
    prompt += '4. 시장분석 : 각 마트별 특징과 배치된 물품들을 기준으로 장단점을 나타냄\n';
    prompt += '5. 추천 수입 제품: 한국 시장에서 성공할 가능성이 높은 수입 제품과 그 이유.\n';
    prompt += '6. 가격 전략 및 유통 전략: 시장에서 경쟁력을 가질 수 있는 가격 전략과 유통 경로 확립 방안.\n';
    prompt += '7. 추가 시장조사 필요성: 향후 추가적으로 시장조사가 필요한 제품군 및 분석 방법론 제안.\n';
    prompt += '8. 결론 및 제안: 종합적인 시장 분석을 기반으로 한 전략적 제안과 실행 방안.\n';
    prompt +=
