...
export default function PageOne() {
  ...
  const coupangProductMappings = {
    ...
    '88469063181': { name: 'coupangTenL', description: 'SNP**합천 햇양파(왕특) 10kg', boxSize: '소', size: "tenL", price: 0 },
    '88469063192': { name: 'coupangTenL', description: 'SNP**합천 햇양파(특) 10kg', boxSize: '소', size: "tenL", price: 0 },
    '88469063201': { name: 'coupangTenM', description: 'SNP**합천 햇양파(대) 10kg', boxSize: '소', size: "tenM", price: 0 },
    '88469063208': { name: 'coupangTenS', description: 'SNP**합천 햇양파(중) 10kg', boxSize: '소', size: "tenS", price: 0 },
    '88469063224': { name: 'coupangFiveL', description: 'SNP**합천 햇양파(왕특) 15kg', boxSize: '중', size: "fiveL", price: 4500 },
    '88469063234': { name: 'coupangFiveL', description: 'SNP**합천 햇양파(특) 15kg', boxSize: '중', size: "fiveL", price: 4500 },
    '88469063242': { name: 'coupangFiveM', description: 'SNP**합천 햇양파(대) 15kg', boxSize: '중', size: "fiveM", price: 4500 },
    '88469063257': { name: 'coupangFiveS', description: 'SNP**합천 햇양파(중) 15kg', boxSize: '중', size: "fiveS", price: 4500 },
    '88469063263': { name: 'coupangFiveSSS', description: 'SNP**합천 햇양파(장아찌) 15kg', boxSize: '중', size: "fiveSSS", price: 4500 },
    '88469063217': { name: 'coupangTenSSS', description: 'SNP**합천 햇양파(장아찌) 10kg', boxSize: '소', size: "tenSSS", price: 0 },
    ...
    //5키로 추가
    '88469063161': { name: 'coupangFiveL', description: 'SNP**합천 햇양파(왕특) 5kg', boxSize: '소', size: "realfiveL", price: 0 },
    '88469063165': { name: 'coupangFiveM', description: 'SNP**합천 햇양파(특) 5kg', boxSize: '소', size: "realfiveM", price: 0 },
    '88469063168': { name: 'coupangFiveS', description: 'SNP**합천 햇양파(상) 5kg', boxSize: '소', size: "realfiveS", price: 0 },
    '88469063173': { name: 'coupangFiveSS', description: 'SNP**합천 햇양파(중) 5kg', boxSize: '소', size: "realfiveSS", price: 0 },
    '88469063177': { name: 'coupangFiveSSS', description: 'SNP**합천 햇양파(장아찌) 5kg', boxSize: '소', size: "realfiveSSS", price: 0 },
    ...
    //마늘추가
    '88469063052': { name: 'coupangCarrotTen', description: '2023년산-깐마늘1kg(대) 1개', boxSize: '소', size: "garlicOneL", price: 0 },
    '88469063058': { name: 'coupangCarrotTen', description: '2023년산-깐마늘1kg(중) 1개', boxSize: '소', size: "garlicOneM", price: 0 },
    '88469063068': { name: 'coupangCarrotTen', description: '2023년산-깐마늘1kg(소) 1개', boxSize: '소', size: "garlicOneS", price: 0 },
    //10kg
    '88469063076': { name: 'coupangCarrotTen', description: '2023년산-깐마늘10kg(대) 1개', boxSize: '소', size: "garlicTenL", price: 0 },
    '88469063083': { name: 'coupangCarrotTen', description: '2023년산-깐마늘10kg(중) 1개', boxSize: '소', size: "garlicTenM", price: 0 },
    '88469063092': { name: 'coupangCarrotTen', description: '2023년산-깐마늘10kg(소) 1개', boxSize: '소', size: "garlicTenS", price: 0 },
    ...
    //20kg
    '88469063097': { name: 'coupangCarrotTen', description: '2023년산-깐마늘20kg(대) 1개', boxSize: '중', size: "garlicTwentyL", price: 5500 },
    '88469063101': { name: 'coupangCarrotTen', description: '2023년산-깐마늘20kg(중) 1개', boxSize: '중', size: "garlicTwentyM", price: 5500 },
    '88469063107': { name: 'coupangCarrotTen', description: '2023년산-깐마늘20kg(소) 1개', boxSize: '중', size: "garlicTwentyS", price: 5500 },

    //감자 5kg
    '88469062983': { name: 'coupangPotatoFiveXXL', description: '감자(왕특) 5kg', boxSize: '소', size: "potatoFiveXXL", price: 0 },
    '88469062996': { name: 'coupangPotatoFiveXL', description: '감자(특) 5kg', boxSize: '소', size: "potatoFiveXL", price: 0 },
    '88469063007': { name: 'coupangPotatoFiveL', description: '감자(상) 5kg', boxSize: '소', size: "potatoFiveL", price: 0 },
    '88469063018': { name: 'coupangPotatoFiveM', description: '감자(중) 5kg', boxSize: '소', size: "potatoFiveM", price: 0 },

    //깐양파 10kg
    '88469062828': { name: 'coupangPotatoFiveXXL', description: '2023년산-10kg 깐양파(대) 1box', boxSize: '소', size: "onionTenL", price: 0 },
    '88469062842': { name: 'coupangPotatoFiveXL', description: '2023년산-10kg 깐양파(중) 1box', boxSize: '소', size: "onionTenM", price: 0 },
    '88469062857': { name: 'coupangPotatoFiveL', description: '2023년산-10kg 깐양파(소) 1box', boxSize: '소', size: "onionTenS", price: 0 },
    ...
    //무 5kg
    '90720316015': { name: 'coupangPotatoFiveXXL', description: '무-5kg-1box', boxSize: '극소', size: "radishFive", price: 0 },
    '90720316031': { name: 'coupangPotatoFiveXXL', description: '무-10kg-1box', boxSize: '소', size: "radishTen", price: 0 },

    // 통마늘 5,10, 반접 추가 20240716
    '90720434940': { name: 'coupangCarrotTen', description: '2024년산-햇마늘5kg(대)-Garlic 1개', boxSize: '극소', size: "realGarlicFiveL", price: 0 },
    '90720434870': { name: 'coupangCarrotTen', description: '2024년산-햇마늘5kg(중)-Garlic 1개', boxSize: '극소', size: "realGarlicFiveM", price: 0 },
    '90720434930': { name: 'coupangCarrotTen', description: '2024년산-햇마늘5kg(소)-Garlic 1개', boxSize: '극소', size: "realGarlicFiveS", price: 0 },

    '90720434953': { name: 'coupangCarrotTen', description: '2024년산-햇마늘10kg(대)-Garlic 1개', boxSize: '소', size: "realGarlicTenL", price: 0 },
    '90720434879': { name: 'coupangCarrotTen', description: '2024년산-햇마늘10kg(중)-Garlic 1개', boxSize: '소', size: "realGarlicTenM", price: 0 },
    '90720434947': { name: 'coupangCarrotTen', description: '2024년산-햇마늘10kg(소)-Garlic 1개', boxSize: '소', size: "realGarlicTenS", price: 0 },

    '90720434889': { name: 'coupangCarrotTen', description: '2024년산-햇마늘반접(50개)(대)-Garlic 1개', boxSize: '극소', size: "realGarlicFiftyL", price: 0 },
    '90720434864': { name: 'coupangCarrotTen', description: '2024년산-햇마늘반접(50개)(중)-Garlic 1개', boxSize: '극소', size: "realGarlicFiftyM", price: 0 },
    '90720434856': { name: 'coupangCarrotTen', description: '2024년산-햇마늘반접(50개)(소)-Garlic 1개', boxSize: '극소', size: "realGarlicFiftyS", price: 0 },


    //손질 적양파 3kg 추가 
    '90720586559': { name: 'coupangPotatoFiveXXL', description: '(red)손질-깐적양파-3kg-(대)', boxSize: '극소', size: "peeledRedOnionThreeL", price: 0 },
    '90720586578': { name: 'coupangPotatoFiveXXL', description: '(red)손질-깐적양파-3kg-(중)', boxSize: '극소', size: "peeledRedOnionThreeM", price: 0 },
    '90720586568': { name: 'coupangPotatoFiveXXL', description: '(red)손질-깐적양파-3kg-(소)', boxSize: '극소', size: "peeledRedOnionThreeS", price: 0 },

    //당근 3kg - 5kg 
    '90720687547': { name: 'coupangPotatoFiveXXL', description: '당근3kg 1box', boxSize: '극소', size: "carrotThree", price: 0 },
    '90720687557': { name: 'coupangPotatoFiveXL', description: '당근5kg 1box', boxSize: '극소', size: "carrotFive", price: 0 },

    //양배추 추가 3kg, 9kg
    '90720811300': { name: 'coupangPotatoFiveXXL', description: '양배추-3kg-1box', boxSize: '극소', size: "cabbageThree", price: 0 },
    '90720811292': { name: 'coupangPotatoFiveXXL', description: '양배추-9kg-1box', boxSize: '소', size: "cabbageNine", price: 0 },

    // 홍산마늘 5,10, 반접 추가 20240718
    '90727952246': { name: 'coupangCarrotTen', description: '2024년산-홍산마늘5kg(대)-Garlic 1개', boxSize: '극소', size: "hongSanRealGarlicFiveL", price: 0 },
    '90727952242': { name: 'coupangCarrotTen', description: '2024년산-홍산마늘5kg(중)-Garlic 1개', boxSize: '극소', size: "hongSanRealGarlicFiveM", price: 0 },
    '90727952236': { name: 'coupangCarrotTen', description: '2024년산-홍산마늘5kg(소)-Garlic 1개', boxSize: '극소', size: "hongSanRealGarlicFiveS", price: 0 },

    '90727952221': { name: 'coupangCarrotTen', description: '2024년산-홍산마늘10kg(대)-Garlic 1개', boxSize: '소', size: "hongSanRealGarlicTenL", price: 0 },
    '90727952226': { name: 'coupangCarrotTen', description: '2024년산-홍산마늘10kg(중)-Garlic 1개', boxSize: '소', size: "hongSanRealGarlicTenM", price: 0 },
    '90727952231': { name: 'coupangCarrotTen', description: '2024년산-홍산마늘10kg(소)-Garlic 1개', boxSize: '소', size: "hongSanRealGarlicTenS", price: 0 },

    '90727952213': { name: 'coupangCarrotTen', description: '2024년산-홍산마늘반접(50개)(대)-Garlic 1개', boxSize: '극소', size: "hongSanRealGarlicFiftyL", price: 0 },
    '90727952249': { name: 'coupangCarrotTen', description: '2024년산-홍산마늘반접(50개)(중)-Garlic 1개', boxSize: '극소', size: "hongSanRealGarlicFiftyM", price: 0 },
    '90727952208': { name: 'coupangCarrotTen', description: '2024년산-홍산마늘반접(50개)(소)-Garlic 1개', boxSize: '극소', size: "hongSanRealGarlicFiftyS", price: 0 },
