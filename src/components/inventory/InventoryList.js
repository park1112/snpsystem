...
import { TextField, Box, Typography, Button, Table, TableBody, TableCell, TableHead, TableRow, IconButton, TableContainer, Paper, CircularProgress } from '@mui/material';
                    ...
                    <TableBody>
                        {sortedInventories.map((inventory, index) => (
                            ...
                            >
                                ...
                                <TableCell>
                                    <IconButton onClick={(e) => { e.stopPropagation(); router.push(`/inventory/${inventory.id}/edit`); }}>
                                        <Edit />
                                    </IconButton>
                                    <IconButton onClick={(e) => { e.stopPropagation(); handleDeleteInventory(inventory.id); }}>
                                        <Delete />
                                    </IconButton>
                                </TableCell>
                            </TableRow>
